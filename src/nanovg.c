...
// Experimental: tesselate shaped directly into the drawlist buffer (avoids
// additional copy, but obfuscates program flow)
// TODO disabling since the assertion fails
#define NVG_FILL_DISPLAYLIST_BUFFER_DIRECT 0
